...
This features is used in combination with the special set of ['E.' functions](https://annotation.github.io/text-fabric/tf/cheatsheet.html#special-edge-feature-oslots). For example, the following snippet shows the nodes associated with node #382714 (= verse node for Matt. 1:1):
