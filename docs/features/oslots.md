...
This features is used in combination with the special set of ['E.' functions](https://annotation.github.io/text-fabric/tf/cheatsheet.html#special-edge-feature-oslots). 
